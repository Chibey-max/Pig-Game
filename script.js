...
const score0El = document.querySelector(`#score--0`); // Same with this
...
btnRoll.addEventListener(`click`, () => {
  if (playing) {
    ...
    const dice = Math.trunc(Math.random() * 6) + 1; // Math.trunc added here will give a number ranging from 1 - 5, so will added + 1 that"s = 6
    // Display dice
